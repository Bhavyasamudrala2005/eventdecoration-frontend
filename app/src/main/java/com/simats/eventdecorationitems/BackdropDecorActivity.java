...
public class BackdropDecorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_backdrop_decor);
        ...
        bookNowButton.setOnClickListener(v -> {
            Intent intent = new Intent(BackdropDecorActivity.this, ProceedToBookingActivity.class);
            intent.putExtra("itemName", "Backdrop Decor");
            intent.putExtra("itemImage", R.drawable.ic_backdrop_decor);
