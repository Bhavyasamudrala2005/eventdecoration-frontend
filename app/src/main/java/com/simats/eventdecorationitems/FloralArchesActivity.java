...
public class FloralArchesActivity extends AppCompatActivity {

    private int quantity = 1;
    private int duration = 1;
    private final int pricePerDay = 220;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_floral_arches);
        ...
        bookNowButton.setOnClickListener(v -> {
            Intent intent = new Intent(FloralArchesActivity.this, ProceedToBookingActivity.class);
            intent.putExtra("itemName", "Floral Arches");
            intent.putExtra("itemImage", R.drawable.ic_floral_arches);
