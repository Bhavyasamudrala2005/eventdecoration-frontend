...
public class VipCushionedChairsActivity extends AppCompatActivity {

    private int quantity = 1;
    private int duration = 1;
    private final int pricePerDay = 200;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vip_cushioned_chairs);
        ...
        bookNowButton.setOnClickListener(v -> {
            Intent intent = new Intent(VipCushionedChairsActivity.this, ProceedToBookingActivity.class);
            intent.putExtra("itemName", "VIP Cushioned Chairs");
            intent.putExtra("itemImage", R.drawable.ic_vip_chairs);
