...
public class WeddingChairsActivity extends AppCompatActivity {

    private int quantity = 1;
    private int duration = 1;
    private final int pricePerDay = 150;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wedding_chairs);
        ...
        bookNowButton.setOnClickListener(v -> {
            Intent intent = new Intent(WeddingChairsActivity.this, ProceedToBookingActivity.class);
            intent.putExtra("itemName", "Wedding Chairs");
            intent.putExtra("itemImage", R.drawable.ic_wedding_chairs);
