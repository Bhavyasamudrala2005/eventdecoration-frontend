...
public class PlasticChairsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plastic_chairs);
        ...
        bookNowButton.setOnClickListener(v -> {
            Intent intent = new Intent(PlasticChairsActivity.this, ProceedToBookingActivity.class);
            intent.putExtra("itemName", "Plastic Chairs");
            intent.putExtra("itemImage", R.drawable.ic_plastic_chair);
