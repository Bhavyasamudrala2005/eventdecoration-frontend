...
public class FlowerStandsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_flower_stands);
        ...
        bookNowButton.setOnClickListener(v -> {
            Intent intent = new Intent(FlowerStandsActivity.this, ProceedToBookingActivity.class);
            intent.putExtra("itemName", "Flower Stands");
            intent.putExtra("itemImage", R.drawable.ic_flower_stands);
