...
public class StageSpeakerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stage_speaker);
        ...
        bookNowButton.setOnClickListener(v -> {
            Intent intent = new Intent(StageSpeakerActivity.this, ProceedToBookingActivity.class);
            intent.putExtra("itemName", "Stage Speakers");
            intent.putExtra("itemImage", R.drawable.ic_stage_speakers);
    ...
    private void updatePrice() {
        ...
        totalAmount.setText("₹" + (pricePerDay * quantity * duration));
        totalAmountCalculation.setText(quantity + " item(s) x " + duration + " day(s)");
    }
}
