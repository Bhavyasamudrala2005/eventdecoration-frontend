...
public class GasStovesActivity extends AppCompatActivity {

    private int quantity = 1;
    private int duration = 1;
    private int pricePerDay = 40;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gas_stoves);
        ...
        bookNowButton.setOnClickListener(v -> {
            Intent intent = new Intent(GasStovesActivity.this, ProceedToBookingActivity.class);
            intent.putExtra("itemName", "Gas Stoves");
            intent.putExtra("itemImage", R.drawable.ic_gas_stove);
