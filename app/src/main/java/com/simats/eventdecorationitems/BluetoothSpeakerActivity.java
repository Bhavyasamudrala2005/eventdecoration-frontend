...
public class BluetoothSpeakerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookNowButton.setOnClickListener(v -> {
            Intent intent = new Intent(BluetoothSpeakerActivity.this, ProceedToBookingActivity.class);
            intent.putExtra("itemName", "Bluetooth Speakers");
            intent.putExtra("itemImage", R.drawable.ic_bluetooth_speaker);
