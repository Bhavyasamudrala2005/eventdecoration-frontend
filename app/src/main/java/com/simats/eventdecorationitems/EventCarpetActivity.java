...
public class EventCarpetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_event_carpet);
        ...
        bookNowButton.setOnClickListener(v -> {
            Intent intent = new Intent(EventCarpetActivity.this, ProceedToBookingActivity.class);
            intent.putExtra("itemName", "Event Carpet");
            intent.putExtra("itemImage", R.drawable.ic_event_carpet);
