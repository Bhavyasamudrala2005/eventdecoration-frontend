...
public class StagePlatformActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stage_platform);
        ...
        bookNowButton.setOnClickListener(v -> {
            Intent intent = new Intent(StagePlatformActivity.this, ProceedToBookingActivity.class);
            intent.putExtra("itemName", "Stage Platform");
            intent.putExtra("itemImage", R.drawable.ic_stage_platform);
