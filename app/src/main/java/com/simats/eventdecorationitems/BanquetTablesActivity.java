...
public class BanquetTablesActivity extends AppCompatActivity {

    private int quantity = 1;
    private int duration = 1;
    private final int pricePerDay = 400;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_banquet_tables);
        ...
        bookNowButton.setOnClickListener(v -> {
            Intent intent = new Intent(BanquetTablesActivity.this, ProceedToBookingActivity.class);
            intent.putExtra("itemName", "Banquet Tables");
            intent.putExtra("itemImage", R.drawable.ic_banquet_tables);
