...
public class LargeCookingVesselsActivity extends AppCompatActivity {

    private int quantity = 1;
    private int duration = 1;
    private final int pricePerDay = 300;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_large_cooking_vessels);
        ...
        bookNowButton.setOnClickListener(v -> {
            Intent intent = new Intent(LargeCookingVesselsActivity.this, ProceedToBookingActivity.class);
            intent.putExtra("itemName", "Large Cooking Vessels");
            intent.putExtra("itemImage", R.drawable.ic_large_cooking_vessels);
