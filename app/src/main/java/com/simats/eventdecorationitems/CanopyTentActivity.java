...
public class CanopyTentActivity extends AppCompatActivity {

    private int quantity = 1;
    private int duration = 1;
    private int pricePerDay = 200;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_canopy_tent);
        ...
        bookNowButton.setOnClickListener(v -> {
            Intent intent = new Intent(CanopyTentActivity.this, ProceedToBookingActivity.class);
            intent.putExtra("itemName", "Canopy Tent");
            intent.putExtra("itemImage", R.drawable.ic_canopy_tent);
