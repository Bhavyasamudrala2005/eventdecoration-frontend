...
public class SmallShadeTentActivity extends AppCompatActivity {

    private int quantity = 1;
    private int duration = 1;
    private int pricePerDay = 80;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_small_shade_tent);
        ...
        bookNowButton.setOnClickListener(v -> {
            Intent intent = new Intent(SmallShadeTentActivity.this, ProceedToBookingActivity.class);
            intent.putExtra("itemName", "Small Shade Tent");
            intent.putExtra("itemImage", R.drawable.ic_small_shade_tent);
