...
public class LargeEventSpeakersActivity extends AppCompatActivity {

    private int quantity = 1;
    private int duration = 1;
    private final int pricePerDay = 150; // Example price
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_large_event_speakers);
        ...
        bookNowButton.setOnClickListener(v -> {
            Intent intent = new Intent(LargeEventSpeakersActivity.this, ProceedToBookingActivity.class);
            intent.putExtra("itemName", "Large Event Speakers");
            intent.putExtra("itemImage", R.drawable.ic_large_event_speakers);
