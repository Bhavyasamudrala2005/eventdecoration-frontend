...
public class CookingVesselsAdapter extends RecyclerView.Adapter<CookingVesselsAdapter.CookingVesselViewHolder> {

    private List<CookingVessel> cookingVesselList;

    public CookingVesselsAdapter(List<CookingVessel> cookingVesselList) {
        ...
        holder.viewDetailsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (cookingVessel.getName().equals("Large Cooking Vessels")) {
                    ...
                    intent.putExtra("itemName", cookingVessel.getName());
                    intent.putExtra("itemPrice", cookingVessel.getPrice());
                    intent.putExtra("itemImage", cookingVessel.getImage());
                    v.getContext().startActivity(intent);
                }
            }
        });
