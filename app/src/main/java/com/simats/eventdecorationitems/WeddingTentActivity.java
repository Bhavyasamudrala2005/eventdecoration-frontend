...
public class WeddingTentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wedding_tent);
        ...
        bookNowButton.setOnClickListener(v -> {
            Intent intent = new Intent(WeddingTentActivity.this, ProceedToBookingActivity.class);
            intent.putExtra("itemName", "Wedding Tent");
            intent.putExtra("itemImage", R.drawable.ic_wedding_tent);
