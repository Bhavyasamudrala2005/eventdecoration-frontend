...
public class LedLightingSystemActivity extends AppCompatActivity {

    private int quantity = 1;
    private int duration = 1;
    private final int pricePerDay = 250;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_led_lighting_system);
        ...
        bookNowButton.setOnClickListener(v -> {
            Intent intent = new Intent(LedLightingSystemActivity.this, ProceedToBookingActivity.class);
            intent.putExtra("itemName", "LED Lighting System");
            intent.putExtra("itemImage", R.drawable.ic_led_lighting);
