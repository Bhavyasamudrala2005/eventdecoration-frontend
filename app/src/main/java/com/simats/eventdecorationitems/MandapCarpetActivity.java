...
public class MandapCarpetActivity extends AppCompatActivity {

    private int quantity = 1;
    private int duration = 1;
    private final int pricePerDay = 600;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mandap_carpet);
        ...
        bookNowButton.setOnClickListener(v -> {
            Intent intent = new Intent(MandapCarpetActivity.this, ProceedToBookingActivity.class);
            intent.putExtra("itemName", "Mandap Carpet");
            intent.putExtra("itemImage", R.drawable.ic_mandap_carpet);
